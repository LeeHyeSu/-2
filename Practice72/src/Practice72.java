...
public class Practice72 {
	...
	public static void main(String[] args) throws IOException{
		...
		while(true) {
			...
			if (oper == 0) {
				...
				String loadFname = input.next();
				System.out.println();
				
				load(loadFname, BankList);
			}
			else if (oper == 2) {
				System.out.print("파일 이름을 입력하세요: ");
				String saveFname = input.next();
				
				save(saveFname, BankList);
				System.out.println();
			}
			else if (oper == 3) {
	...
	public static void save(String fname, ArrayList<BankAccount> list) throws IOException {
